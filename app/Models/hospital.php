...
class Hospital extends Authenticatable implements AuthenticatableContract
{
    ...
    {
        return $this->hasMany(User_vaccine::class, 'hosp_id');
    }
    public function bookings()
    {
        return $this->hasMany(Booking::class, 'hosp_id');
    }
    protected static function boot()
    {
        ...
        static::updated(function ($hospital) {
            if ($hospital->permission === 'yes') {
                ...
                if ($existingTimings === 0) {
                    ...
                    $vaccines = [
                        ...
                        'Sinovac (CoronaVac)',
                        'AstraZeneca (distributed under the name "Vaxzevria")',
            ...
            elseif ($hospital->permission === 'no') {
                ...
                vaccine::where('hosp_id', $hospital->id)->delete();
            }
        });
    }
