...
<body class="container bg-dark p-5">
    <sections class="container bg-dark p-5">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h6 class="loginAS_head mb-3">Hospital - Sign In</h6>
            </div>
            <div class="col-lg-6 mb-3 d-flex justify-content-end">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="" class="btn P_btn_login P_btn_login_active">Sign In</a>
                    <a href="/hospital" class="btn P_btn_login">Sign Up</a>
                </div>
            </div>
            <hr style="color: white;">
            <div class="col-12 mt-5 pt-5 d-flex justify-content-center">
                <form action="h_login" class="text-light" method="Post">
                    @csrf
                     <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label ">Enter Email</label>
                        <input type="email" class="form-control P_btn_FI" name="email" id="email" aria-describedby="emailHelpId" placeholder="abc@mail.com">
                        @if($errors->has('email'))
                    ...
                    @endif
                    <button type="submit" class="btn float-end P_btn_login">Sign In</button>
                </form>
            </div>
