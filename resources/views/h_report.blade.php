    ...
    <div class="row">
        <div class="col-8 mx-auto">
            <form action="/tests/report/" method="POST">
                @csrf
                <div class="mb-3">
                    <!-- <label class="form-label" for="inputName">Test id</label> -->
                    <input type="hidden" class="form-control " readonly name="test_id" id="inputName" value="{{$test_id}}" placeholder="">
                </div>
                <div class="mb-3">
                    <!-- <label class="form-label" for="inputName">User id</label> -->
                    <input type="hidden" class="form-control " readonly name="user_id" id="inputName" value="{{$user_id}}" placeholder="">
                </div>
                <div class="mb-3">
                    <!-- <label class="form-label" for="inputName">Hospital id</label> -->
                    <input type="hidden" class="form-control" readonly name="hosp_id" id="inputName" value="{{$hosp_id}}" placeholder="">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-select-md" name="vaccine_id" id="">
                        <option selected value="">No Vaccination Needed</option>
